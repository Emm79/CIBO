...
//        });
        ...
        btn_aceptar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(pwd_T.length()<4){
                    Toast.makeText(Registrarse.this, "Ingresa una contraseña con mas de 4 caracteres", Toast.LENGTH_LONG).show();
                }

                else {
                    mAuth.createUserWithEmailAndPassword(correo_T, pwd_T)
